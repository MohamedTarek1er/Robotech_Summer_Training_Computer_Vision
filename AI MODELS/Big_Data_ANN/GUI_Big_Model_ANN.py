...
# Load trained model
model = load_model(r"C:\Users\moham\Downloads\Robotech\Summer_Training\Project\Note_Book\ANN_Mediapipe\ASL1_Big_Data\asl_mlp_model.h5")

# Load class labels
with open(r"C:\Users\moham\Downloads\Robotech\Summer_Training\Project\Note_Book\ANN_Mediapipe\ASL1_Big_Data\label_dict1.pkl", "rb") as f:
...
class SignLanguageApp:
    def __init__(self, root):
        ...
        self.repeat_count = 0  # counts how many frames we saw the same label
    ...
    def update_video(self):
        ...
        # === Stability logic (repeat same label many frames) ===
